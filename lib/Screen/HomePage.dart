...
class _HomePageState extends State<HomePage>
  ...
  Widget _slider() {
    double height = deviceHeight! / 4.0;
                  ...
                  homeSliderList,
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: context.read<HomeProvider>().curSlider == index ? Theme.of(context).colorScheme.fontColor : Theme.of(context).colorScheme.lightBlack,
                      ),
                    );
                  },
  ...
  _getSection(int i) {
    ...
    return sectionList[i].style == DEFAULT
        ...
        child: ListView.builder(
            itemCount: sectionList[i].productList?.length??0,
            scrollDirection: Axis.horizontal,
            itemBuilder: (_, index) {
              return productItem(i, index, index % 3 == 0 ? true : false);
            })
    )
